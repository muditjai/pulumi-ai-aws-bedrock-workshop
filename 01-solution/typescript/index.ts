...
// Hash the agent source to force a runtime update when code changes.
// Without this, AgentCore keeps running the old container even after
// CodeBuild pushes a new image to the same :latest tag.
